...
HD_PWD='/home/mdl/izo5011/IkennaWorkSpace/cnn_layer_accel/hardware/ip_viv2018.3/xcvu37p-fsvh2892-2-e/managed_ip_project/managed_ip_project.runs/job_fetch_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log job_fetch_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source job_fetch_fifo.tcl
