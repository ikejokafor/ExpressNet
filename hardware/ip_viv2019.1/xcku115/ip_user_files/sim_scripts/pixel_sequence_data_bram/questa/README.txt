...
#
# Generated by export_simulation on Fri Mar 30 16:57:22 -0400 2018
#
################################################################################
...
switch to the './pixel_sequence_data_bram.sh' script.

./pixel_sequence_data_bram.sh -reset_run
...
./pixel_sequence_data_bram.sh -noclean_files

For more information on the script, please type './pixel_sequence_data_bram.sh -help'.
