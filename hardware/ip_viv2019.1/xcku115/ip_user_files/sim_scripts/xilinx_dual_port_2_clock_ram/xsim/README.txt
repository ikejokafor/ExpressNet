...
#
# Generated by export_simulation on Tue Mar 20 15:44:03 EDT 2018
#
################################################################################
...
./xilinx_dual_port_2_clock_ram.sh
...
switch to the './xilinx_dual_port_2_clock_ram.sh' script.

./xilinx_dual_port_2_clock_ram.sh -reset_run
...
./xilinx_dual_port_2_clock_ram.sh -noclean_files

For more information on the script, please type './xilinx_dual_port_2_clock_ram.sh -help'.
