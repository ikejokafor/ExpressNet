...
#
# Generated by export_simulation on Tue Mar 20 15:20:37 EDT 2018
#
################################################################################
...
./xilinx_async_fwft_fifo_count.sh
...
switch to the './xilinx_async_fwft_fifo_count.sh' script.

./xilinx_async_fwft_fifo_count.sh -reset_run
...
./xilinx_async_fwft_fifo_count.sh -noclean_files

For more information on the script, please type './xilinx_async_fwft_fifo_count.sh -help'.
