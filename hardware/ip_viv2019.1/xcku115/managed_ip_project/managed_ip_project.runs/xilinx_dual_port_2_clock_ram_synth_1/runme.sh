...
HD_PWD='/home/mdl/izo5011/SOC_IT/cnn_layer_accel/hardware/ip/xcku115/managed_ip_project/managed_ip_project.runs/xilinx_dual_port_2_clock_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_dual_port_2_clock_ram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source xilinx_dual_port_2_clock_ram.tcl
