...
#
# Generated by Vivado on Wed Dec 01 13:30:33 EST 2021
...
# Script info
echo -e "ddr4.sh - Script generated by export_simulation (Vivado v2019.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_3 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../ddr4/ip_1/rtl/map" +incdir+"$ref_dir/../../../../ddr4/rtl/ip_top" +incdir+"$ref_dir/../../../../ddr4/rtl/cal" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/mdl/izo5011/IkennaWorkSpace/cnn_layer_accel/hardware/ip_viv2019.1/xcvu37p-fsvh2892-2-e/managed_ip_project/managed_ip_project.cache/compile_simlib/vcs"
  fi
