...
#
# Generated by export_simulation on Fri Mar 30 16:57:21 -0400 2018
#
################################################################################
...
switch to the './prefetch_buffer_fifo.sh' script.

./prefetch_buffer_fifo.sh -reset_run
...
./prefetch_buffer_fifo.sh -noclean_files

For more information on the script, please type './prefetch_buffer_fifo.sh -help'.
