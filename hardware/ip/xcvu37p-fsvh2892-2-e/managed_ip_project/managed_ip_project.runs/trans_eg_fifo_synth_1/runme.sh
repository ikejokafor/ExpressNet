...
HD_PWD='/home/mdl/izo5011/IkennaWorkSpace/cnn_layer_accel/hardware/ip/xcvu37p-fsvh2892-2-e/managed_ip_project/managed_ip_project.runs/trans_eg_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trans_eg_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trans_eg_fifo.tcl
