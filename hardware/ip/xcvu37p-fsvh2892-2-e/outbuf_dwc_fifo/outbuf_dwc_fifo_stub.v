...
// Command     : write_verilog -force -mode synth_stub -rename_top outbuf_dwc_fifo -prefix
//               outbuf_dwc_fifo_ conv1x1_dwc_fifo_stub.v
...
module outbuf_dwc_fifo(clk, srst, din, wr_en, rd_en, dout, full, empty, valid, 
