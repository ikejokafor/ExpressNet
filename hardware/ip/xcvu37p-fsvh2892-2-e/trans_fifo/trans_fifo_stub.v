...
// Command     : write_verilog -force -mode synth_stub -rename_top trans_fifo -prefix
//               trans_fifo_ trans_fifo_stub.v
// Design      : trans_fifo
...
module trans_fifo(srst, wr_clk, rd_clk, din, wr_en, rd_en, dout, full, 
