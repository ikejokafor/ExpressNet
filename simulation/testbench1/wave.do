...
add wave -noupdate -group QUAD /testbench_1/i0_cnn_layer_accel_quad/ST_IDLE_1
add wave -noupdate -group QUAD /testbench_1/i0_cnn_layer_accel_quad/ST_JOB_DONE
add wave -noupdate -group QUAD /testbench_1/i0_cnn_layer_accel_quad/ST_ROW_REQUEST
...
add wave -noupdate -group QUAD /testbench_1/i0_cnn_layer_accel_quad/next_row
...
add wave -noupdate -group {CTRL} /testbench_1/i0_cnn_layer_accel_quad/i0_cnn_layer_accel_quad_bram_ctrl/prev_state
...
update
WaveRestoreZoom {5090 ns} {5185 ns}
